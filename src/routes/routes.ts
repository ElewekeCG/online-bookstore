...
const models: TsoaRoute.Models = {
    "ReviewResult": {
        ...
        "properties": {
            ...
            "reviewText": {"dataType":"string","required":true},
        },
    ...
    "CartItem": {
        "dataType": "refObject",
        "properties": {
            "bookId": {"ref":"mongoose.Types.ObjectId","required":true},
    ...
    "BookProduct": {
        ...
        "properties": {
            "id": {"dataType":"string","required":true},
            "author": {"ref":"mongoose.Types.ObjectId","required":true},
            "publisher": {"ref":"mongoose.Types.ObjectId","required":true},
            "title": {"dataType":"string","required":true},
            "ISBN": {"dataType":"string","required":true},
            "genre": {"dataType":"string","required":true},
            "publicationYear": {"dataType":"double","required":true},
            "price": {"dataType":"double","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.post('/api/v1/reviews/add',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(ReviewController)),
            ...(fetchMiddlewares<RequestHandler>(ReviewController.prototype.addBook)),

            async function ReviewController_addBook(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    body: {"in":"body","name":"body","required":true,"ref":"ReviewParams"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/v1/reviews/:book/get',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(ReviewController)),
            ...(fetchMiddlewares<RequestHandler>(ReviewController.prototype.getReviews)),

            async function ReviewController_getReviews(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        app.post('/api/v1/order/checkout',
            ...
            ...(fetchMiddlewares<RequestHandler>(OrderController.prototype.checkout)),

            async function OrderController_checkout(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    body: {"in":"body","name":"body","required":true,"ref":"OrderRequest"},
            };
        ...
        app.post('/api/v1/cart/add',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"CartRequest"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.patch('/api/v1/cart/removeItem',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(CartController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/api/v1/cart/:customerId',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(CartController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/v1/cart/:customerId/view',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(CartController)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/v1/admin/books/add',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(AdminController)),
            ...(fetchMiddlewares<RequestHandler>(AdminController.prototype.addBook)),

            async function AdminController_addBook(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    body: {"in":"body","name":"body","required":true,"ref":"AvailableBooks"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/api/v1/admin/inventory/update',
            authenticateMiddleware([{"jwt":[]}]),
            ...(fetchMiddlewares<RequestHandler>(AdminController)),
            ...(fetchMiddlewares<RequestHandler>(AdminController.prototype.updateInventory)),
